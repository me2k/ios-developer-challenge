...
public enum Fonts {
    ...
    /*
     ...
     private static let fontNameBold = "HelveticaNeue-Bold"
     private static let fontNameMedium = "HelveticaNeue-Medium"
     private static let fontNameLight = "HelveticaNeue-Light"
     */
    ...
    public var font: UIFont { // * UIDevice.current.screenScale
